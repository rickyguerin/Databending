...
In general, I would also recommend that you open your image in GIMP and make sure that the layer has an **alpha channel**. This allows your databending result to have transparency, and will make it easier to put together a cool final product in the Postprocessing section.
